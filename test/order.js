...
//		this.comp('orderData').filters.setVar("user", this._userID);
	...
	var url = require.toUrl("../cart/json/address.json");
	allData.loadDataFromFile(url,event.source,true);
	...
	var url = require.toUrl("../cart/json/goods.json");
	allData.loadDataFromFile(url,event.source,true);
...
//		}
	...
	var url = require.toUrl("../cart/json/sendTime.json");
	allData.loadDataFromFile(url,event.source,true);
