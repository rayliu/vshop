...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card x-has-iosstatusbar"
    ...
    <li class="list-group-item" xid="li1" bind-click="li1Click" style="line-height:30px;">我的订单
        <span class="pull-right text-muted" xid="span1"><![CDATA[订单记录
      ]]></span>  
       <i xid="i7" class="icon-android-note"/> 
      </li>   
      <li class="list-group-item" xid="li4" bind-click="li4Click" style="line-height:30px;">资料管家
        <span class="pull-right text-muted" xid="span4"><![CDATA[个人资料、常用资料]]></span>  
        <i xid="i20" class="icon-android-storage"/> 
      </li>  
      <li class="list-group-item" xid="li5" bind-click="li5Click" style="line-height:30px;">收货地址
