...
public class WxMpJsApi{
	...
	private static void chooseWXPay(HttpServletRequest req, HttpServletResponse resp) throws IOException{
	    ...
	    System.out.println("chooseWXPay params-----------");
	    System.out.println("appId:" + payReq.get("appId"));
	    System.out.println("timeStamp:" + payReq.get("timeStamp"));
	    System.out.println("nonceStr:" + payReq.get("nonceStr"));
	    System.out.println("package:" + payReq.get("package"));
	    System.out.println("signType:" + payReq.get("signType"));
	    System.out.println("paySign:" + payReq.get("paySign"));
	...
	private static WxJsapiPrepayOrder getPrepayOrder(HttpServletRequest req){
		System.out.println("enter getPrepayOrder....");
		...
		System.out.println("getPrepayOrder params-----------");
	    System.out.println("OpenId:" + oauth2AccessToken.getOpenId());
	    System.out.println("AppId:" + instance.getWxMpConfigStorage().getAppId());
	    System.out.println("body:" + req.getParameter("body"));
	    System.out.println("mchId:" + req.getParameter("mchId"));
	    System.out.println("notifyUrl:" + req.getParameter("notifyUrl"));
	    System.out.println("outTradeNo:" + req.getParameter("outTradeNo"));
	    System.out.println("SpbillCreateIp:" + req.getRemoteAddr());
	    System.out.println("TotalFee:" + req.getParameter("totalFee"));
		...
		try {
			...
			System.out.println("after getPrepayOrder....");
			return prepayOrder;
