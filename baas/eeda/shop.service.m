...
<model> 
	...
	<action name="queryChildTable" impl="eeda.controller.LatoService.queryChildTable" />
	<action name="createChildOrder" impl="eeda.controller.LatoService.createChildOrder" />
	<action name="deleteQueryOrder" impl="eeda.controller.LatoService.deleteQueryOrder" />
</model>