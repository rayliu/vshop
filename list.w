...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <span xid="span36"/>
  <div component="$UI/system/components/justep/model/model" xid="model" style="left:82px;top:230px;height:188px;width:164px;"
    onParamsReceive="modelParamsReceive" onLoad="modelLoad" onunLoad="modelUnLoad"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      xid="商品表" idColumn="编号" onDataChange="goodsDataCustomRefresh"> 
  ...
  <column label="商品类别" name="商品类别" type="String" xid="xid3"></column></div>  
 ...
 <!--    <div component="$UI/system/components/justep/data/baasData" autoLoad="false"
      xid="baasCategoryGoodsData" queryAction="queryCategoryGoods" tableName="category"
      url="/eeda/shop" idColumn="id" onCustomRefresh="">
      <column label="id" name="id" type="String" xid="default63"/>  
      <column label="fShopID" name="fShopID" type="String" xid="default64"/>  
      <column label="fTitle" name="fTitle" type="String" xid="default65"/>  
      <column label="fImg" name="fImg" type="String" xid="default66"/>  
      <column label="fPrice" name="fPrice" type="Float" xid="default67"/>  
      <column label="fPostage" name="fPostage" type="String" xid="default68"/>  
      <column label="fRecord" name="fRecord" type="Integer" xid="default69"/> 
    </div>  --> 
    </div>  
    ...
    <div xid="content" class="x-panel-content tb-trans"> 
      <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
                  ...
                  <li xid="li1" class="media"> 
                    ...
                    <div class="media-body" xid="div14"> 
                      ...
                      <div class="text-muted" xid="div16"> 
                       ...
                       <!--  <span xid="span33" bind-text="ref('category_id')"/> -->
                      </div> 
                    </div> 
                  </li> 
                </ul> 
        ...
        <div class="x-contents-content  x-scroll-view" xid="twoColList"> 
          <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
            xid="scrollView2" onPullDown="scrollViewPullDown"> 
            ...
            <div class="x-scroll-content" xid="div17"> 
              <div class="col-xs-6 tb-twoColList"> 
                <div component="$UI/system/components/justep/list/list" class="x-list x-flex"
                  data="商品表" limit="3" filter="$row.index()%2==0" xid="list2"
              ...
              <div class="col-xs-6 tb-twoColList"> 
                <div component="$UI/system/components/justep/list/list" class="x-list x-flex"
                  data="商品表" limit="3" bind-click="listClick" filter="$row.index()%2==1"
                  xid="list4"> 
